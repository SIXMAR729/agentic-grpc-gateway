...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Login = channel.unary_unary(
                '/my_api.v1.AuthService/Login',
                request_serializer=order__api__pb2.LoginRequest.SerializeToString,
                response_deserializer=order__api__pb2.LoginResponse.FromString,
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Login': grpc.unary_unary_rpc_method_handler(
                    servicer.Login,
                    request_deserializer=order__api__pb2.LoginRequest.FromString,
                    response_serializer=order__api__pb2.LoginResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'my_api.v1.AuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('my_api.v1.AuthService', rpc_method_handlers)
...
class AuthService(object):
    ...
    def Login(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/my_api.v1.AuthService/Login',
            order__api__pb2.LoginRequest.SerializeToString,
            order__api__pb2.LoginResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class ProductServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListProducts = channel.unary_stream(
                ...
                response_deserializer=order__api__pb2.Product.FromString,
                _registered_method=True)
        self.SearchProducts = channel.unary_stream(
                '/my_api.v1.ProductService/SearchProducts',
                request_serializer=order__api__pb2.SearchProductsRequest.SerializeToString,
                response_deserializer=order__api__pb2.Product.FromString,
                _registered_method=True)
...
def add_ProductServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SearchProducts': grpc.unary_stream_rpc_method_handler(
                    servicer.SearchProducts,
                    request_deserializer=order__api__pb2.SearchProductsRequest.FromString,
                    response_serializer=order__api__pb2.Product.SerializeToString,
            ),
...
class ProductService(object):
    ...
    def SearchProducts(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/my_api.v1.ProductService/SearchProducts',
            order__api__pb2.SearchProductsRequest.SerializeToString,
            order__api__pb2.Product.FromString,
            options,
            channel_credentials,
            insecure,
